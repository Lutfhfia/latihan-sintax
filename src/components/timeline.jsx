      ...
      <ul className="timeline timeline-snap-icon max-md:timeline-compact timeline-vertical">
        <li>
          ...
          <div className="timeline-start mb-10 md:text-end">
            ...
            Mempelajari instalasi dan pemahaman awal tentang React
          </div>
          <hr />
        </li>
        <li>
          ...
          <div className="timeline-end md:mb-10">
            ...
            <div className="text-lg font-black">Pemahaman Dasar Lanjutan</div>
            Mempelajari Tampilan ,seperti tata letak, flex dan membut id card
          </div>
          <hr />
        </li>
        <li>
          ...
          <div className="timeline-start mb-10 md:text-end">
            ...
            <div className="text-lg font-black">Membanggun Tampilan Web</div>
